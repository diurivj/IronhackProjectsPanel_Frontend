      ...
      <div style={{display:'flex', alignItems:'center', justifyContent:'center', width:'100vw', height:'100vh', flexGrow: '1', flexWrap:'wrap'}}>
        <div style={{width:'100%', margin: '5px 1%', height:'15%' }}>
          <Card title='Title of your project'>
            <Input type='text' placeholder='Title' name='title' onChange={this.handleChange} value={project.title}/>
          </Card>
        </div>
        <div style={{width: '30%', margin: '1%' }}>
          <Card hoverable={true} title='Slides'>
            ...
            <Divider/>
              <Input type='url' name='presentation_slides' placeholder="Slides URL" onChange={this.handleChange} value={project.presentation_slides}/>
          </Card>
        </div>
        <div style={{width: '30%', margin: '1%'}}>
          <Card title='Deployed Site'>
            ...
            <Divider/>
            <Input type='url' name='deployed_site' placeholder="Deployed Site URL" onChange={this.handleChange} value={project.deployed_site}/>
          </Card>
        </div>
        <div style={{width: '30%', margin: '1%'}}>
          <Card title='Github'>
            ...
            <Divider/>
            <Input type='url' name='github_repo' placeholder="Github URL" onChange={this.handleChange} value={project.github_repo}/>
          </Card>
        </div>
